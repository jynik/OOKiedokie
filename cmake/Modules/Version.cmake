...
#
if(DEFINED __INCLUDED_OOKIEDOKIE_VERSION_CMAKE)
    return()
endif()
set(__INCLUDED_OOKIEDOKIE_VERSION_CMAKE TRUE)
...
if(GIT_FOUND)
    ...
    message(WARNING "git missing -- unable to check OOKiedokie changeset.")
